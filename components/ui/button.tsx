  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-indigo-400 cursor-pointer text-white hover:bg-indigo-400/90 border-indigo-500 border-b-4 active:border-b-0",
        primaryOrange: "bg-orange-400 text-primary-foreground hover:bg-orange-400/90 border-orange-500 border-b-4 active:border-b-0",
        outline: "bg-white text-indigo-500 hover:bg-slate-100",
        secondary: "bg-purple-500 cursor-pointer text-primary-foreground hover:bg-purple-500/90 border-purple-600 border-b-4 active:border-b-0",
        ...
        LogoutOutline: "bg-white text-indigo-500 border-gray-300 border-2 hover:bg-gray-600/20 transition-none border-b-4 active:border-b-0"
      },
      size: {
